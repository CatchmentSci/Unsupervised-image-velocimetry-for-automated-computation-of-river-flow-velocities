...
%DIF ADD C:\_git_local\Unsupervised-image-velocimetry-for-automated-computation-of-river-flow-velocities\Main\Initial_submission_2024\article_v2.tex   Mon Apr  7 10:46:23 2025
%% ---------------------------------
...
\citep{Chiu1989, Moramarco2010, Bahmanpouri2022, vyas2024}}\hskip0pt%DIFAUXCMD
...
\DIFdelbegin \DIFdel{In the generation of a camera model to be used for the generation of orthophotos which are subsequently analysed to determine feature displacement, an assumption is made that the water surface is planar. Under normal flow conditions this assumption is valid. However, under high flow conditions, surface waves of considerable height (>> 10cm) develop resulting in variable water surface elevations throughout the domain. Given the perspective of the camera, these surface undulations may result in biased flow velocity estimates due to part of the downstream component being registered as normal to the main flow line, or alternatively part of the normal component being registered as contributing to the downstream flow rate}\DIFdelend \DIFaddbegin \DIFadd{A final assumption of the image-based approach is the presence of a stable channel cross-section and downstream control at the experimental site. Whilst there is evidence for significant geomorphic change at this site (in 1979), one of the reasons for this location being selected was due to the stability of the cross-section over the intervening years. This is indirectly evidenced by the presence of a stable rating curve \mbox{%DIFAUXCMD
\citep{ceh2024}}\hskip0pt%DIFAUXCMD
. Furthermore, as reported, our analysis of repeat surveys in 2010, 2018, and 2020 indicate that the cross-section has changed by no-more than 5\% across the full range of flows experienced. However, at monitoring locations where the cross-section is unstable, error assessments should be conducted}\DIFaddend .
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{thebibliography}{68}
...
\bibitem[{Ansari et~al.(2023)Ansari, Rennie, Jamieson, Seidou, and
  Clark}]{Ansari2023}
...
%DIFDELCMD < %%%
\DIFdelend \bibitem[{Muste et~al.(2008)Muste, Fujita, and Hauet}]{Muste2008}
...
\bibitem[{Perks et~al.(2024)Perks, Pitman, Bainbridge, Diaz-Moreno, and
  Dunning}]{perks2024}
\DIFadd{Perks, M., Pitman, S., Bainbridge, R., Diaz-Moreno, A., and Dunning, S.:
  An evaluation of low-cost terrestrial lidar sensors for assessing
  hydrogeomorphic change, Earth and Space Science, 11, e2024EA003\,514, 2024.
}\DIFaddend 

\bibitem[{Perks(2020)}]{Perks2020a}
...
\bibitem[{Perks(2025)}]{alpha_analysis}
Perks, M.~T.: Surface alpha coefficients following analysis of aDcp transects,
  \doi{10.25405/data.ncl.28581962}, 2025.
